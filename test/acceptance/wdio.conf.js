...
exports.config = {
  ...
  capabilities: [
    {
      ...
      browserName: 'chrome',
      // "host": "app",
      // comment the below tage to run the code in normal browsers in local
      'goog:chromeOptions': {
  ...
  // uncomment this for running tests locally
  // services: [
  //     ['chromedriver', {
  ...
  // Uncomment the below tag if you to run it in local
  services: [
    [
      'chromedriver',
      {
        path: '/Users/bt-ilker/Code',
        outputDir: 'driver-logs', // overwrites the config.outputDir
        args: ['--silent'], //
      },
    ],
